...
const columnDefs = [
  ...
  {
    headerName: "Lab_Followup_Billed",field: "lab_Followup_Billed", editable: false,
    editable: params => params.value !== "Billed", 
    cellStyle: params =>{
      return params.value === "Billed" ? { backgroundColor: 'green', color: 'white', cursor: 'not-allowed' } : null
    } ,
  ...
  { headerName: "Procedure_Advised", field: "proc_Billed",editable: true }, 
